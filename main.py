...
def menu_ufuncs():
    ...
    valores_anterior = np.array([1_200_000, 900_000, 0, 2_100_000,
    800_000, 3_000_000, 500_000, 1_000_000,], dtype=np.float64)
...
def katherine():
    """
    Dada una lista con cinco elementos de tipo entero, haciendo uso de la repetición for . muestra en pantalla la suma de esos 5 elementos, 
    para ello vamos a usar 2 formas de suma. una con variable (de tipo acumulador). y la segunda forma es usando la instrucción sum.

    """

    # lista con cinco elementos tipo entero 
...
if __name__ == "__main__":
    main()
    #katherine()
    #medir_diferencia_vectorizacion(100)
